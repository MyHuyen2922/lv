...
<?php
    ...
    $tienship = $_GET['tienship'];
    $tenmon = explode("|",$_GET['tenmon']);
    $soluong = explode("|",$_GET['soluong']);
    $size = explode("|",$_GET['size']);
    $gia = explode("|",$_GET['gia']);
?>
<html lang="en">
    <head>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <p class="tieude">Số lượng</p>
                <p class="tieude">Giá</p>
                <p class="tieude">Size</p>
                <p class="tieude">Thành tiền</p>
            </div>
                <div class="">
                    <div class="row">
                        <div>
                            <?php 
                                for($i = 0; $i < count($tenmon); $i++){
                                    if($i == 0){
                                        continue;
                                    }
                                    else{
                                        ...
                                        echo"<p class='tt'>$size[$i]</p>";
                                        echo"<p class='tt'>$thanhtien</p>";
                                    }
                                }
                            ?>
                         </div>
                ...
                <form action="/vnpay_php/vnpay_create_payment.php" id="create_form" method="post">       
                    <div class="hidden">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="order_id" name="order_id" type="text" value="<?php echo $_GET['iddh'] ?>"/>
                        </div>
                        <div class="form-group">
                            <label for="amount">Số tiền</label>
                            <input class="form-control" id="amount"
                                name="amount" type="number" value="<?php echo ($tongtien + $tienship) ?>"/>
                        </div>
                        <div class="form-group">
                    ...
                    <button type="submit" name="redirect" id="redirect" class="btn btn-default"></button>
                </form>
            </div>
            <p>
                &nbsp;
